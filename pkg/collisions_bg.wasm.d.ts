...
export function world_momentum(a: number): number;
...
export function world_step_frame(a: number, b: number, c: number, d: number): number;
export function world_step_dt(a: number, b: number, c: number): number;
